...
void mutationMoinsBons(Population *population)
{
 ...
 (void)population;
// Les moins bons ne sont pas cloné 
int nbIndividusNonClone = population->nbIndividus - population->nbClones;
Ac *individu;
...
void remplacementMauvaisParNouveaux(Population *population, int nbNouveaux)
{
 (void)population; (void)nbNouveaux;
  ...
  //Pour chaque individu non cloné -> recréer un nouvel anticorps tout neuf totalement aléatoire
